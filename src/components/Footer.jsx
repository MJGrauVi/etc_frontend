...
/* ============================================================
   COMPONENTE ICON — Declarado fuera del render (ESLint OK)
   ============================================================ */
...
const Footer = () => {
  ...
  /* ============================================================
     ICONOS — Solo para el Footer (no se reutilizan fuera)
     ============================================================ */
  const ICONOS = {
    email: (
      <path
      ...
      <div className="px-6 py-16 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="flex flex-col">
            <Link to="/" className="mb-6 text-2xl font-black tracking-tighter text-white">
              ETC<span className="text-primary">.</span>
            </Link>

            <div className="space-y-4 text-sm">
              <a href="mailto:etc-apps@proton.me" className="flex items-center gap-3 hover:text-white">
                <span className="text-primary"><Icon>{ICONOS.email}</Icon></span>
                etc-apps@proton.me
              </a>

              <a href="https://etc-apps.com" target="_blank" rel="noopener noreferrer"
                 className="flex items-center gap-3 hover:text-white">
                <span className="text-primary"><Icon>{ICONOS.web}</Icon></span>
                etc-apps.com
              </a>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-3 text-sm">
              ...
              <a href="mailto:etc-apps@proton.me" className="hover:text-primary">Soporte</a>
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {/* Facebook */}
              <a href="https://facebook.com/etc_apps" target="_blank" rel="noopener noreferrer"
                 className="p-2 bg-gray-800 rounded-full hover:bg-primary hover:text-white">
              ...
              {/* Instagram */}
              <a href="https://instagram.com/etc_apps" target="_blank" rel="noopener noreferrer"
                 className="p-2 bg-gray-800 rounded-full hover:bg-primary hover:text-white">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/etc-apps" target="_blank" rel="noopener noreferrer"
                 className="p-2 bg-gray-800 rounded-full hover:bg-primary hover:text-white">
              ...
              {/* X */}
              <a href="https://x.com/etc_apps" target="_blank" rel="noopener noreferrer"
                 className="p-2 bg-gray-800 rounded-full hover:bg-primary hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
